...
const STRINGS: Record<LanguageCode, Record<StringKey, string>> = {
  en: {
    ...
    "landing.heroBody": "Tasks, calendar, habits, and an AI co-pilot — synced across every device. A daily editorial briefing, Telegram bot, and MCP integration that lets your AI assistant manage your tasks natively.",
  ...
  "zh-TW": {
    ...
    "landing.heroBody": "任務、日曆、習慣與 AI 副駕駛 — 跨裝置即時同步。每日編輯式簡報、Telegram 機器人,以及 MCP 整合讓你的 AI 助手直接管理你的任務。",
  ...
  "zh-CN": {
    ...
    "landing.heroBody": "任务、日历、习惯与 AI 副驾驶 — 跨设备实时同步。每日编辑式简报、Telegram 机器人,以及 MCP 整合让你的 AI 助手直接管理你的任务。",
  ...
  ja: {
    ...
    "landing.heroBody": "タスク、カレンダー、習慣、AIコパイロット — 全デバイスでリアルタイム同期。毎朝のエディトリアルブリーフィング、Telegramボット、MCP統合でAIアシスタントがタスクを直接管理。",
  ...
  ko: {
    ...
    "landing.heroBody": "할 일, 캘린더, 습관, AI 코파일럿 — 모든 기기에서 실시간 동기화. 매일 아침 에디토리얼 브리핑, 텔레그램 봇, MCP 통합으로 AI 어시스턴트가 직접 할 일을 관리합니다.",

...
const STRINGS: Record<LanguageCode, Record<StringKey, string>> = {
  en: {
    ...
    "landing.heroBody": "Every morning, First Light writes you a short editorial about your day: what matters, what can wait, what your patterns are telling you. Tasks, calendar, and habits underneath — with native MCP so your AI assistant manages them directly.",
  ...
  "zh-TW": {
    ...
    "landing.kicker": "First Light · 沉靜而專注的每一天",
    "landing.heroLine1": "每天一則晨間簡報 —",
    "landing.heroLine2": "取代你永遠滑不完的待辦清單。",
    "landing.heroBody": "每天早上，First Light 為你寫一段關於今天的簡報：哪些事情重要、哪些可以緩一緩、你的工作節奏正在告訴你什麼。任務、行事曆、習慣一目瞭然 — 內建 MCP 協定，讓 AI 助手直接幫你安排。",
    ...
    "landing.principle5Body": "照亮前方，持續前進。",
  ...
  "zh-CN": {
    ...
    "landing.heroBody": "每天早上，First Light 为你写一段关于今天的简报：哪些事情重要、哪些可以缓一缓、你的工作节奏正在告诉你什么。任务、日历、习惯一目了然 — 内建 MCP 协议，让 AI 助手直接帮你安排。",
  ...
  ja: {
    ...
    "landing.kicker": "First Light · 穏やかに、着実に進む毎日を",
    "landing.heroLine1": "朝、一度だけ読むブリーフィング —",
    "landing.heroLine2": "終わりのないタスクリストは、もう要らない。",
    "landing.heroBody": "毎朝、First Light があなたの一日を読み解いて短いブリーフィングを届けます。何が大事か、何は後でいいか、日々の習慣が何を示しているか。タスク・カレンダー・習慣が一画面に — MCP対応で、AIアシスタントがそのまま管理できます。",
    ...
    "landing.principle5Title": "光",
    "landing.principle5Body": "前に進むための、小さな光。",
  ...
  ko: {
    ...
    "landing.kicker": "First Light · 차분하고 집중된 하루를 위해",
    "landing.heroLine1": "아침에 한 번 읽는 브리핑 —",
    "landing.heroLine2": "끝없이 스크롤하는 할 일 목록은 이제 그만.",
    "landing.heroBody": "매일 아침 First Light가 오늘 하루를 짧은 브리핑으로 정리합니다. 뭐가 중요한지, 뭘 미뤄도 되는지, 내 패턴이 뭘 알려주는지. 할 일·캘린더·습관이 한눈에 — MCP 지원으로 AI 어시스턴트가 바로 관리할 수 있습니다.",
    ...
    "landing.principle5Body": "앞으로 나아가게 하는 작은 빛.",

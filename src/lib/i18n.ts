...
export type StringKey =
  ...
  | "pricing.plan.plus.name"
  | "pricing.plan.pro.name"
  | "pricing.plan.pro.badge"
  | "pricing.cta.openApp"
  | "pricing.cta.startFree"
  | "pricing.cta.upgradePlus"
  | "pricing.cta.upgradePro"
  | "pricing.cta.startWithPro"
  | "pricing.cta.openingCheckout"
  | "pricing.matrix.heading"
  | "pricing.matrix.subheading"
  | "pricing.faq.heading"
  ...
  | "pricing.final.note"
  | "pricing.final.ctaFree"
  /* compare index page */
  | "compare.kicker"
  | "compare.heading"
  | "compare.subheading"
  /* compare detail pages */
  | "compare.kicker.detail"
  | "compare.cta.heading"
  | "compare.cta.subheading"
  | "compare.cta.button"
  | "compare.whenFL"
  | "compare.whenComp"
  | "compare.updated"
  ...
  | "compare.table.fl"
  /* todoist */
  | "compare.todoist.heading"
  | "compare.todoist.body"
  | "compare.todoist.whenFL.1" | "compare.todoist.whenFL.2" | "compare.todoist.whenFL.3" | "compare.todoist.whenFL.4"
  | "compare.todoist.whenComp.1" | "compare.todoist.whenComp.2" | "compare.todoist.whenComp.3"
  /* things */
  | "compare.things.heading"
  | "compare.things.body"
  | "compare.things.whenFL.1" | "compare.things.whenFL.2" | "compare.things.whenFL.3" | "compare.things.whenFL.4"
  | "compare.things.whenComp.1" | "compare.things.whenComp.2" | "compare.things.whenComp.3" | "compare.things.whenComp.4"
  /* ticktick */
  | "compare.ticktick.heading"
  | "compare.ticktick.body"
  | "compare.ticktick.whenFL.1" | "compare.ticktick.whenFL.2" | "compare.ticktick.whenFL.3" | "compare.ticktick.whenFL.4"
  | "compare.ticktick.whenComp.1" | "compare.ticktick.whenComp.2" | "compare.ticktick.whenComp.3" | "compare.ticktick.whenComp.4"
  /* features page */
  | "features.heading"
  | "features.subheading"
  | "features.yourPlan"
  ...
  | "features.renews"
  | "features.freeTip"
  | "features.manageBilling"
  | "features.openingPortal"
  | "features.upgradePlus"
  | "features.upgradePro"
  | "features.redirecting"
  | "features.unlockHeading"
  | "features.matrixHeading"
  | "features.matrixSubFree"
  | "features.matrixSubPlus"
  | "features.matrixSubPro"
  | "features.shareLink"
  | "features.publicPricing"
...
const STRINGS: Record<LanguageCode, Record<StringKey, string>> = {
  en: {
    ...
    "landing.kicker": "First Light · The moment possibility becomes visible.",
    "landing.heroLine1": "A briefing you read once —",
    "landing.heroLine2": "not a backlog you scroll forever.",
    "landing.heroBody": "First Light turns scattered tasks, calendar, and habits into one AI-written daily briefing — then lets you and your AI assistant act on it together. No copy-pasting. No switching apps.",
    ...
    /* shared nav */
    "nav.backToHome": "Back to First Light",
    "nav.openApp": "Open app",
    /* pricing page */
    "pricing.kicker": "PRICING",
    "pricing.hero.heading": "Built for the way you actually plan.",
    "pricing.hero.body": "Free covers the full task system, indefinitely. Plus unlocks two-way calendar and unlimited daily editions. Pro adds the full AI co-pilot \u2014 Plan my day, Voice \u2192 Task, and the review suite.",
    "pricing.plan.free.name": "Free",
    "pricing.plan.plus.name": "Plus",
    "pricing.plan.pro.name": "Pro",
    "pricing.plan.pro.badge": "Recommended",
    "pricing.cta.openApp": "Open the app",
    "pricing.cta.startFree": "Start free",
    "pricing.cta.upgradePlus": "Upgrade to Plus",
    "pricing.cta.upgradePro": "Upgrade to Pro",
    "pricing.cta.startWithPro": "Start with Pro",
    "pricing.cta.openingCheckout": "Opening checkout\u2026",
    "pricing.matrix.heading": "Everything, side by side",
    "pricing.matrix.subheading": "The complete list of what\u2019s included in each plan.",
    "pricing.faq.heading": "Common questions",
    "pricing.faq.q1": "Can I cancel anytime?",
    "pricing.faq.a1": "Yes. Use the customer portal in Settings \u2192 Billing. Your subscription stays active until the end of the period you\u2019ve already paid for.",
    "pricing.faq.q2": "What happens to my data if I downgrade?",
    "pricing.faq.a2": "Your data is yours. Tasks, notes, and calendar links keep working on Free; only the Pro-only AI features stop running.",
    "pricing.faq.q3": "Is there a team plan?",
    "pricing.faq.a3": "Not yet. We\u2019re focused on making the single-player experience excellent first.",
    "pricing.faq.q4": "What languages does First Light support?",
    "pricing.faq.a4": "English, Traditional Chinese, Simplified Chinese, Japanese, and Korean \u2014 with native CJK typography tuned per language.",
    "pricing.faq.q5": "Does First Light work on mobile?",
    "pricing.faq.a5": "Yes. First Light is a progressive web app that works on any device \u2014 phone, tablet, or desktop. Install it from your browser for an app-like experience.",
    "pricing.faq.q6": "How does the AI Daily Edition work?",
    "pricing.faq.a6": "Every morning, First Light reads your calendar, tasks, and deadlines, then writes you a short editorial briefing \u2014 like a personal newspaper for your day. Free gets 1 per day; Plus and Pro get unlimited.",
    "pricing.faq.q7": "Is my data secure?",
    "pricing.faq.a7": "Yes. First Light uses Supabase (built on PostgreSQL) with row-level security. Your data is encrypted in transit and at rest. We never sell your data.",
    "pricing.final.note": "Free forever for the core task system. Cancel Pro anytime.",
    "pricing.final.ctaFree": "Start free \u2014 no card needed",
    /* compare index */
    "compare.kicker": "COMPARISONS",
    "compare.heading": "How First Light compares",
    "compare.subheading": "Honest, side-by-side comparisons. We tell you when to pick us \u2014 and when the other tool might be a better fit.",
    /* compare detail shared */
    "compare.kicker.detail": "COMPARISON",
    "compare.cta.heading": "Try First Light free",
    "compare.cta.subheading": "AI-native task management with MCP, Telegram, and smart daily planning.",
    "compare.cta.button": "Get started free",
    "compare.whenFL": "When to choose First Light",
    "compare.whenComp": "When to choose",
    "compare.updated": "Last updated: June 2026",
    "compare.table.feature": "Feature",
    "compare.table.fl": "First Light",
    /* todoist */
    "compare.todoist.heading": "First Light vs Todoist",
    "compare.todoist.body": "Both First Light and Todoist help you organize tasks and plan your day. But they take fundamentally different approaches \u2014 Todoist is a proven productivity platform with deep integrations, while First Light is built AI-first with native MCP support, letting your AI assistant manage your tasks directly.",
    "compare.todoist.whenFL.1": "You want your AI assistant (Claude, ChatGPT) to manage your tasks directly via MCP",
    "compare.todoist.whenFL.2": "You prefer adding tasks from Telegram, voice, email, or screenshots",
    "compare.todoist.whenFL.3": "You want an Eisenhower matrix + focus timer + habit tracking in one app",
    "compare.todoist.whenFL.4": "You want AI to plan your day around energy levels and priorities",
    "compare.todoist.whenComp.1": "You need deep team collaboration with shared projects and comments",
    "compare.todoist.whenComp.2": "You rely on 100+ third-party integrations (Zapier, Slack, etc.)",
    "compare.todoist.whenComp.3": "You want a mature ecosystem with desktop, mobile, and browser extensions",
    /* things */
    "compare.things.heading": "First Light vs Things 3",
    "compare.things.body": "Things 3 is beloved for its beautiful design and native Apple experience. First Light takes a different approach \u2014 AI-first task management with MCP integration, letting your AI assistant plan your day directly.",
    "compare.things.whenFL.1": "You want your AI assistant to manage tasks via MCP",
    "compare.things.whenFL.2": "You need cross-platform access (Windows, Android, Linux)",
    "compare.things.whenFL.3": "You want focus timer, habits, and Eisenhower matrix built in",
    "compare.things.whenFL.4": "You prefer AI-powered daily planning",
    "compare.things.whenComp.1": "You live in the Apple ecosystem and want polished native apps",
    "compare.things.whenComp.2": "You prefer one-time purchase over subscription",
    "compare.things.whenComp.3": "You want full offline support with no internet required",
    "compare.things.whenComp.4": "Design polish is your #1 priority",
    /* ticktick */
    "compare.ticktick.heading": "First Light vs TickTick",
    "compare.ticktick.body": "TickTick and First Light share several features \u2014 both have focus timers and habit tracking. But First Light goes further with native AI integration via MCP, letting your AI assistant read, create, and reorganize your tasks directly.",
    "compare.ticktick.whenFL.1": "You want your AI assistant to manage tasks via MCP",
    "compare.ticktick.whenFL.2": "You want AI to understand context and plan your day intelligently",
    "compare.ticktick.whenFL.3": "You prefer adding tasks from Telegram, voice, email, or screenshots",
    "compare.ticktick.whenFL.4": "You want a minimalist, focused planning experience",
    "compare.ticktick.whenComp.1": "You want a built-in calendar view with time blocking",
    "compare.ticktick.whenComp.2": "You need native apps on every platform (iOS, Android, Mac, Windows)",
    "compare.ticktick.whenComp.3": "You want team collaboration with shared lists",
    "compare.ticktick.whenComp.4": "You prefer a free tier with more included features",
    /* features page */
    "features.heading": "Features",
    "features.subheading": "What\u2019s available on each plan, and what you have access to right now.",
    "features.yourPlan": "YOUR PLAN",
    "features.plan.free": "Free",
    "features.plan.plus": "Plus",
    "features.plan.pro": "Pro",
    "features.cancels": "Cancels at the end of the current period",
    "features.renews": "Renews automatically",
    "features.freeTip": "The full task system. Add the AI co-pilot anytime.",
    "features.manageBilling": "Manage billing",
    "features.openingPortal": "Opening portal\u2026",
    "features.upgradePlus": "Upgrade to Plus",
    "features.upgradePro": "Upgrade to Pro",
    "features.redirecting": "Redirecting\u2026",
    "features.unlockHeading": "WHAT YOU UNLOCK",
    "features.matrixHeading": "Side by side",
    "features.matrixSubFree": "Lock icons mark features that aren\u2019t included in your tier.",
    "features.matrixSubPlus": "You have everything in Plus. Pro adds the full AI co-pilot.",
    "features.matrixSubPro": "You have access to everything below.",
    "features.shareLink": "Want to share this with someone?",
    "features.publicPricing": "The public pricing page",
  ...
  "zh-TW": {
    ...
    "landing.kicker": "First Light · 與光同行。",
    "landing.heroLine1": "每天一則晨間簡報 —",
    "landing.heroLine2": "取代你永遠滑不完的待辦清單。",
    "landing.heroBody": "First Light 把分散的任務、行事曆、習慣整合成一份 AI 每日簡報 — 再讓你和 AI 助手一起執行。不用複製貼上，不用切換應用。",
    "landing.signupCta": "免費開始",
    "landing.loginCta": "登入",
    "landing.ctaNote": "無需信用卡 · 不追蹤 · 即時同步",
    "landing.headerLogin": "登入",
    "landing.headerSignup": "開始使用",
    "landing.principlesKicker": "設計理念",
    "landing.principlesHeading": "每一天，五個堅持。",
    "landing.principle1Title": "清晰",
    "landing.principle1Body": "想清楚了，才走得穩。",
    "landing.principle2Title": "專注",
    "landing.principle2Body": "一次做好一件事。",
    "landing.principle3Title": "前進",
    "landing.principle3Body": "一小步，也是進步。",
    "landing.principle4Title": "從容",
    "landing.principle4Body": "不急躁，反而更有效率。",
    ...
    "nav.backToHome": "回到 First Light",
    "nav.openApp": "開啟應用",
    "pricing.kicker": "方案該算",
    "pricing.hero.heading": "符合你真實規劃習慣的工具。",
    "pricing.hero.body": "免費涉及完整任務系統，無限期。Plus 解鎖雙向行事曆與無限日報。Pro 包含完整 AI 副駕驩—規劃我的一天、語音轉任務等。",
    "pricing.plan.free.name": "免費",
    "pricing.plan.plus.name": "Plus",
    "pricing.plan.pro.name": "Pro",
    "pricing.plan.pro.badge": "推薦",
    "pricing.cta.openApp": "開啟應用",
    "pricing.cta.startFree": "免費開始",
    "pricing.cta.upgradePlus": "升級至 Plus",
    "pricing.cta.upgradePro": "升級至 Pro",
    "pricing.cta.startWithPro": "以 Pro 開始",
    "pricing.cta.openingCheckout": "開啟結帳畫面…",
    "pricing.matrix.heading": "全功能對照",
    "pricing.matrix.subheading": "每個方案所包含的完整功能列表。",
    "pricing.faq.heading": "常見問題",
    "pricing.faq.q1": "我可以隨時取消吗？",
    "pricing.faq.a1": "可以。在設定 \u2192 費用中使用客戶門戶。訂閱將持續到已付款期間結束。",
    "pricing.faq.q2": "降級後我的資料會怨樣？",
    "pricing.faq.a2": "資料屬於您。任務、筆記和行事曆連結在免費方案中不受影響；僅 Pro 專屬 AI 功能會停止運行。",
    "pricing.faq.q3": "有團隊方案嗎？",
    "pricing.faq.a3": "暫時沒有。我們目前專注於完善單人使用體驗。",
    "pricing.faq.q4": "First Light 支援哪些語言？",
    "pricing.faq.a4": "英文、繁體中文、简体中文、日文、韓文—各語言均配有原生 CJK 字型。",
    "pricing.faq.q5": "First Light 在手機上能用嗎？",
    "pricing.faq.a5": "可以。First Light 是游步式網頁應用，支持任何裝置。從瀏覽器安裝即可享用原生應用體驗。",
    "pricing.faq.q6": "AI 日報是怎麼運作的？",
    "pricing.faq.a6": "每天早晨，First Light 讀取您的行事曆、任務和截止日，撰寫一份簡短編輯想—像個人的日報。免費版每天 1 次；Plus 和 Pro 無限。",
    "pricing.faq.q7": "我的資料安全嗎？",
    "pricing.faq.a7": "安全。First Light 使用 Supabase，資料傳輸和傲存均加密。我們不會出售您的資料。",
    "pricing.final.note": "核心任務系統永遠免費。可隨時取消 Pro。",
    "pricing.final.ctaFree": "免費開始，無需信用卡",
    "compare.kicker": "比較",
    "compare.heading": "First Light 與主要對手的差別",
    "compare.subheading": "誠實的功能對照。我們會告訴你何時選我們，何時另一款工具可能更適合你。",
    "compare.kicker.detail": "比較",
    "compare.cta.heading": "免費體驗 First Light",
    "compare.cta.subheading": "具備 MCP、Telegram 和智慧日常計畫的 AI 原生任務管理。",
    "compare.cta.button": "免費開始",
    "compare.whenFL": "何時選擇 First Light",
    "compare.whenComp": "何時選擇",
    "compare.updated": "更新於 2026 年6 月",
    "compare.table.feature": "功能",
    "compare.table.fl": "First Light",
    "compare.todoist.heading": "First Light vs Todoist",
    "compare.todoist.body": "First Light 和 Todoist 都能幫你組織任務和計劃一天，但方式根本不同。Todoist 是成營已久的生產力平台，First Light 則從 AI 和 MCP 出發。",
    "compare.todoist.whenFL.1": "你希望 AI 助手（Claude、ChatGPT）透過 MCP 直接管理任務",
    "compare.todoist.whenFL.2": "你喜歡透過 Telegram、語音、郵件或截圖新增任務",
    "compare.todoist.whenFL.3": "你想要派烨達矩陣、專注計時器和習慣追蹤一體化",
    "compare.todoist.whenFL.4": "你希望 AI 根據精力和優先層級規劃一天",
    "compare.todoist.whenComp.1": "你需要區工協作、共享專案和討論",
    "compare.todoist.whenComp.2": "你依賴 100+ 第三方整合（Zapier、Slack 等）",
    "compare.todoist.whenComp.3": "你需要成熟的框架，含框面、行動和瀏覽器擴充套件",
    "compare.things.heading": "First Light vs Things 3",
    "compare.things.body": "Things 3 以精美設計和 Apple 原生體驗著稱。First Light 則採取 AI 優先的對決，透過 MCP 讓你的 AI 助手直接規劃一天。",
    "compare.things.whenFL.1": "你希望 AI 助手透過 MCP 管理任務",
    "compare.things.whenFL.2": "你需要跨平台存取（Windows、Android、Linux）",
    "compare.things.whenFL.3": "你想要內建專注計時器、習慣和派烨達矩陣",
    "compare.things.whenFL.4": "你偏好 AI 驅動的日常計劃",
    "compare.things.whenComp.1": "你活在 Apple 生態系統，想要水溿的原生應用",
    "compare.things.whenComp.2": "你偏好一次性購買而非訂閱",
    "compare.things.whenComp.3": "你需要完整離線支援，不需網路也能使用",
    "compare.things.whenComp.4": "設計精美度是你的第一優先",
    "compare.ticktick.heading": "First Light vs TickTick",
    "compare.ticktick.body": "TickTick 和 First Light 有許多相似功能—兩者均具備專注計時器和習慣追蹤。但 First Light 進一步通過 MCP 提供原生 AI 整合。",
    "compare.ticktick.whenFL.1": "你希望 AI 助手透過 MCP 管理任務",
    "compare.ticktick.whenFL.2": "你希望 AI 理解情境并智慧計劃一天",
    "compare.ticktick.whenFL.3": "你喜歡透過 Telegram、語音、郵件或截圖新增任務",
    "compare.ticktick.whenFL.4": "你希望極簡且專注的計劃體驗",
    "compare.ticktick.whenComp.1": "你想要內建行事曆視圖，支持時間區塊",
    "compare.ticktick.whenComp.2": "你需要所有平台的原生應用（iOS、Android、Mac、Windows）",
    "compare.ticktick.whenComp.3": "你需要共享清單的團隊協作",
    "compare.ticktick.whenComp.4": "你偏好免費方案包含更多功能",
    "features.heading": "功能",
    "features.subheading": "每個方案的可用功能，以及您目前的權限。",
    "features.yourPlan": "您的方案",
    "features.plan.free": "免費",
    "features.plan.plus": "Plus",
    "features.plan.pro": "Pro",
    "features.cancels": "當前期間結束後取消",
    "features.renews": "自動續費",
    "features.freeTip": "完整任務系統。隨時可加購 AI 副駕驩。",
    "features.manageBilling": "管理費用",
    "features.openingPortal": "開啟門戶…",
    "features.upgradePlus": "升級至 Plus",
    "features.upgradePro": "升級至 Pro",
    "features.redirecting": "轉向中…",
    "features.unlockHeading": "解鎖內容",
    "features.matrixHeading": "並排對照",
    "features.matrixSubFree": "鎖圖標表示該層級不包含此功能。",
    "features.matrixSubPlus": "您擁有 Plus 的所有功能。Pro 新增完整 AI 副駕驩。",
    "features.matrixSubPro": "您可以使用下方全部功能。",
    "features.shareLink": "想分享給別人？",
    "features.publicPricing": "公開方案頁面",
    /* landing — demo carousel */
  ...
  "zh-CN": {
    ...
    "landing.kicker": "First Light · 沉静而专注的每一天",
    "landing.heroLine1": "每天一则晨间简报 —",
    "landing.heroLine2": "取代你永远滑不完的待办清单。",
    "landing.heroBody": "First Light 把分散的任务、日历、习惯整合成一份 AI 每日简报 — 再让你和 AI 助手一起执行。不用复制粘贴，不用切换应用。",
    "landing.signupCta": "免费开始",
    "landing.loginCta": "登录",
    "landing.ctaNote": "无需信用卡 · 不追踪 · 实时同步",
    "landing.headerLogin": "登录",
    "landing.headerSignup": "开始使用",
    "landing.principlesKicker": "设计理念",
    "landing.principlesHeading": "每一天，五个坚持。",
    "landing.principle1Title": "清晰",
    "landing.principle1Body": "想清楚了，才走得稳。",
    "landing.principle2Title": "专注",
    "landing.principle2Body": "一次做好一件事。",
    "landing.principle3Title": "前进",
    "landing.principle3Body": "一小步，也是进步。",
    ...
    "landing.nav.blog": "博客",
    "nav.backToHome": "返回 First Light",
    "nav.openApp": "打开应用",
    "pricing.kicker": "方案计划",
    "pricing.hero.heading": "专为你的真实规划习惯而打造。",
    "pricing.hero.body": "免费覆盖完整任务系统，无限期。Plus 解锁双向日历与无限日报。Pro 包含完整 AI 副驾驶—规划我的一天、语音转任务等。",
    "pricing.plan.free.name": "免费",
    "pricing.plan.plus.name": "Plus",
    "pricing.plan.pro.name": "Pro",
    "pricing.plan.pro.badge": "推荐",
    "pricing.cta.openApp": "打开应用",
    "pricing.cta.startFree": "免费开始",
    "pricing.cta.upgradePlus": "升级至 Plus",
    "pricing.cta.upgradePro": "升级至 Pro",
    "pricing.cta.startWithPro": "以 Pro 开始",
    "pricing.cta.openingCheckout": "正在打开结账…",
    "pricing.matrix.heading": "全功能对比",
    "pricing.matrix.subheading": "每个方案包含的完整功能列表。",
    "pricing.faq.heading": "常见问题",
    "pricing.faq.q1": "我可以随时取消吗？",
    "pricing.faq.a1": "可以。在设置 \u2192 费用中使用客户门户。订阅将持续至已付款期间结束。",
    "pricing.faq.q2": "降级后我的数据怎么办？",
    "pricing.faq.a2": "数据属于您。任务、笔记和日历连接在免费方案中正常运作；仅 Pro 专属 AI 功能会停止。",
    "pricing.faq.q3": "有团队方案吗？",
    "pricing.faq.a3": "暂时没有。我们目前专注于打造极佳的单人体验。",
    "pricing.faq.q4": "First Light 支持哪些语言？",
    "pricing.faq.a4": "英文、繁体中文、简体中文、日文、韩文—各语言均配有原生 CJK 字体。",
    "pricing.faq.q5": "First Light 能在手机上使用吗？",
    "pricing.faq.a5": "可以。First Light 是渐进式网页应用，支持任何设备。在浏览器安装即可体验原生应用效果。",
    "pricing.faq.q6": "AI 日报是如何运作的？",
    "pricing.faq.a6": "每天早晨，First Light 读取您的日历、任务和截止日，撰写一份简短的编辑小组—如同个人日报。免费版每天 1 次；Plus 和 Pro 无限。",
    "pricing.faq.q7": "我的数据安全吗？",
    "pricing.faq.a7": "安全。First Light 使用 Supabase，数据传输和存储均加密。我们不会出售您的数据。",
    "pricing.final.note": "核心任务系统永久免费。可随时取消 Pro。",
    "pricing.final.ctaFree": "免费开始，无需信用卡",
    "compare.kicker": "对比",
    "compare.heading": "First Light 与其他工具的对比",
    "compare.subheading": "诚实的功能对比。我们会告诉你何时选我们，何时其他工具可能更适合你。",
    "compare.kicker.detail": "对比",
    "compare.cta.heading": "免费体验 First Light",
    "compare.cta.subheading": "具备 MCP、Telegram 和智能日常规划的 AI 原生任务管理。",
    "compare.cta.button": "免费开始",
    "compare.whenFL": "何时选择 First Light",
    "compare.whenComp": "何时选择",
    "compare.updated": "更新于 2026 年6 月",
    "compare.table.feature": "功能",
    "compare.table.fl": "First Light",
    "compare.todoist.heading": "First Light vs Todoist",
    "compare.todoist.body": "First Light 和 Todoist 都能帮你组织任务和规划一天，但方式根本不同。Todoist 是成熟的生产力平台，First Light 则以 AI 和 MCP 为完。",
    "compare.todoist.whenFL.1": "你希望 AI 助手（Claude、ChatGPT）透过 MCP 直接管理任务",
    "compare.todoist.whenFL.2": "你喜欢通过 Telegram、语音、邮件或截图新增任务",
    "compare.todoist.whenFL.3": "你想要艾森豪威矩阵、专注计时器和习惯追踪一体化",
    "compare.todoist.whenFL.4": "你希望 AI 根据精力和优先级规划一天",
    "compare.todoist.whenComp.1": "你需要团队协作、共享项目和评论",
    "compare.todoist.whenComp.2": "你依赖 100+ 第三方集成（Zapier、Slack 等）",
    "compare.todoist.whenComp.3": "你需要成熟的生态，含桌面、移动和浏览器扩展",
    "compare.things.heading": "First Light vs Things 3",
    "compare.things.body": "Things 3 以精美设计和 Apple 原生体验著称。First Light 则采用 AI 优先的策略，通过 MCP 让你的 AI 助手直接规划一天。",
    "compare.things.whenFL.1": "你希望 AI 助手通过 MCP 管理任务",
    "compare.things.whenFL.2": "你需要跨平台访问（Windows、Android、Linux）",
    "compare.things.whenFL.3": "你想要内置专注计时器、习惯和艾森豪威矩阵",
    "compare.things.whenFL.4": "你偏好 AI 驱动的日常规划",
    "compare.things.whenComp.1": "你活在 Apple 生态，想要精致的原生应用",
    "compare.things.whenComp.2": "你偏好一次性购买而非订阅",
    "compare.things.whenComp.3": "你需要完整离线支持，无需网络也能使用",
    "compare.things.whenComp.4": "设计精美度是你的第一优先",
    "compare.ticktick.heading": "First Light vs TickTick",
    "compare.ticktick.body": "TickTick 和 First Light 有许多相似功能—两者均具备专注计时器和习惯追踪。但 First Light 进一步通过 MCP 提供原生 AI 集成。",
    "compare.ticktick.whenFL.1": "你希望 AI 助手通过 MCP 管理任务",
    "compare.ticktick.whenFL.2": "你希望 AI 理解情境并智能规划一天",
    "compare.ticktick.whenFL.3": "你喜欢通过 Telegram、语音、邮件或截图新增任务",
    "compare.ticktick.whenFL.4": "你希望极简且专注的规划体验",
    "compare.ticktick.whenComp.1": "你想要内置日历视图，支持时间块",
    "compare.ticktick.whenComp.2": "你需要所有平台的原生应用（iOS、Android、Mac、Windows）",
    "compare.ticktick.whenComp.3": "你需要共享清单的团队协作",
    "compare.ticktick.whenComp.4": "你偏好免费方案包含更多功能",
    "features.heading": "功能",
    "features.subheading": "每个方案的可用功能，以及您目前的权限。",
    "features.yourPlan": "您的方案",
    "features.plan.free": "免费",
    "features.plan.plus": "Plus",
    "features.plan.pro": "Pro",
    "features.cancels": "当前期间结束后取消",
    "features.renews": "自动续费",
    "features.freeTip": "完整任务系统。随时可加购 AI 副驾驶。",
    "features.manageBilling": "管理费用",
    "features.openingPortal": "正在打开门户…",
    "features.upgradePlus": "升级至 Plus",
    "features.upgradePro": "升级至 Pro",
    "features.redirecting": "跳转中…",
    "features.unlockHeading": "解锁内容",
    "features.matrixHeading": "并排对比",
    "features.matrixSubFree": "锁形图标表示该层级不包含此功能。",
    "features.matrixSubPlus": "您拥有 Plus 的所有功能。Pro 新增完整 AI 副驾驶。",
    "features.matrixSubPro": "您可以使用下方全部功能。",
    "features.shareLink": "想分享给别人？",
    "features.publicPricing": "公开方案页面",
  ...
  ja: {
    ...
    "landing.kicker": "First Light · 光が差すとき、道は見えてくる。",
    "landing.heroLine1": "朝、一度だけ読むブリーフィング —",
    "landing.heroLine2": "終わりのないタスクリストは、もう要らない。",
    "landing.heroBody": "First Light がバラバラなタスク・カレンダー・習慣を一つのAIデイリーブリーフィングに統合 — そしてあなたとAIアシスタントが一緒に実行できます。コピペ不要。アプリ切り替え不要。",
    ...
    "landing.principlesKicker": "デザインの指針",
    "landing.principlesHeading": "毎日、五つの約束。",
    "landing.principle1Title": "明晰",
    "landing.principle1Body": "頭がクリアなら、道もクリア。",
    "landing.principle2Title": "集中",
    "landing.principle2Body": "ひとつずつ、丁寧に。",
    "landing.principle3Title": "進歩",
    "landing.principle3Body": "小さな一歩の積み重ね。",
    "landing.principle4Title": "静けさ",
    "landing.principle4Body": "焦らないほうが、うまくいく。",
    "landing.principle5Title": "光",
    ...
    "nav.backToHome": "First Light に戻る",
    "nav.openApp": "アプリを開く",
    "pricing.kicker": "料金プラン",
    "pricing.hero.heading": "あなたの本当の計画習慣に合わせたツール。",
    "pricing.hero.body": "無料プランはタスク全機能を永遠に提供。Plus は双方向カレンダーと無限の日報を解锁。Pro は完全な AI 副駕驇—一日の計画、音声入力などを含みます。",
    "pricing.plan.free.name": "無料",
    "pricing.plan.plus.name": "Plus",
    "pricing.plan.pro.name": "Pro",
    "pricing.plan.pro.badge": "おすすめ",
    "pricing.cta.openApp": "アプリを開く",
    "pricing.cta.startFree": "無料で始める",
    "pricing.cta.upgradePlus": "Plus にアップグレード",
    "pricing.cta.upgradePro": "Pro にアップグレード",
    "pricing.cta.startWithPro": "Pro で始める",
    "pricing.cta.openingCheckout": "チェックアウトを開いています…",
    "pricing.matrix.heading": "全機能比較",
    "pricing.matrix.subheading": "各プランに含まれる機能の完全なリスト。",
    "pricing.faq.heading": "よくある質問",
    "pricing.faq.q1": "いつでもキャンセルできますか？",
    "pricing.faq.a1": "はい。設定 \u2192 課金のカスタマーポータルをご利用ください。サブスクリプションは支払い済み期間終了まで有効です。",
    "pricing.faq.q2": "ダウングレード後、データはどうなりますか？",
    "pricing.faq.a2": "データはあなたのものです。タスク、ノート、カレンダーとの連携は無料プランでも引き続き機能します。Pro 専用 AI 機能のみ停止します。",
    "pricing.faq.q3": "チームプランはありますか？",
    "pricing.faq.a3": "まだありません。現在は個人利用の体験充実に注力しています。",
    "pricing.faq.q4": "First Light は何語に対応していますか？",
    "pricing.faq.a4": "英語、繁体字中文、簡体字中文、日本語、韓国語—各言語に最適化されたネイティブフォント付き。",
    "pricing.faq.q5": "First Light はスマホで使えますか？",
    "pricing.faq.a5": "はい。First Light はプログレッシブ Web アプリで、どのデバイスでも動作します。ブラウザからインストールするとネイティブアプリのように使えます。",
    "pricing.faq.q6": "AI 日報はどのように機能しますか？",
    "pricing.faq.a6": "毎朝、First Light はカレンダー、タスク、期限を読み取り、簡潔な編集前を書きます—個人の日報のように。無料は 1 回／Plus ・ Pro は無限。",
    "pricing.faq.q7": "データは安全ですか？",
    "pricing.faq.a7": "はい。First Light は Supabase を使用しており、データは通信中および保存中に暗号化されます。データを外部に販売することはありません。",
    "pricing.final.note": "コアのタスク機能は永遠無料。Pro はいつでもキャンセル可能。",
    "pricing.final.ctaFree": "無料で始める，カード不要",
    "compare.kicker": "比較",
    "compare.heading": "First Light と他ツールの比較",
    "compare.subheading": "正直な比較。どちらを選ぶべきか、正直にお伝えします。",
    "compare.kicker.detail": "比較",
    "compare.cta.heading": "First Light を無料で試す",
    "compare.cta.subheading": "MCP、Telegram、AI 日次計画を備えた AI ネイティブタスク管理。",
    "compare.cta.button": "無料で始める",
    "compare.whenFL": "First Light を選ぶべきとき",
    "compare.whenComp": "選ぶべきとき",
    "compare.updated": "2026年6月更新",
    "compare.table.feature": "機能",
    "compare.table.fl": "First Light",
    "compare.todoist.heading": "First Light vs Todoist",
    "compare.todoist.body": "First Light と Todoist はどちらもタスク整理と一日の計画に役立ちますが、アプローチが全く異なります。Todoist は成熟したプラットフォームで、First Light は AI ・ MCP ネイティブです。",
    "compare.todoist.whenFL.1": "AI アシスタント（Claude、ChatGPT）が MCP で直接タスクを管理したい",
    "compare.todoist.whenFL.2": "Telegram、音声、メール、スクリーンショットでタスクを追加したい",
    "compare.todoist.whenFL.3": "アイゼンハワーマトリクス、集中タイマー、習慣追踡を一体化したい",
    "compare.todoist.whenFL.4": "AI にエネルギーと優先度で一日を計画してほしい",
    "compare.todoist.whenComp.1": "チーム共同作業、共有プロジェクト、コメント機能が必要",
    "compare.todoist.whenComp.2": "100以上のサードパーティ連携（Zapier、Slack 等）に依存している",
    "compare.todoist.whenComp.3": "デスクトップ、モバイル、ブラウザ拡張機能を備えた成熟したエコシステムが必要",
    "compare.things.heading": "First Light vs Things 3",
    "compare.things.body": "Things 3 は美しいデザインと Apple ネイティブ体験で知られています。First Light は AI ファーストで MCP 連携を備えています。",
    "compare.things.whenFL.1": "AI アシスタントが MCP でタスクを管理できるようにしたい",
    "compare.things.whenFL.2": "Windows、Android、Linux でクロスプラットフォームアクセスが必要",
    "compare.things.whenFL.3": "集中タイマー、習慣、アイゼンハワーマトリクスが必要",
    "compare.things.whenFL.4": "AI 驱動の日次計画を希望する",
    "compare.things.whenComp.1": "Apple エコシステムで洗練されたネイティブアプリを使いたい",
    "compare.things.whenComp.2": "サブスクリプションではなく買い切り型を希望する",
    "compare.things.whenComp.3": "インターネット不要の完全オフラインサポートが必要",
    "compare.things.whenComp.4": "デザイン品質が第一優先事項である",
    "compare.ticktick.heading": "First Light vs TickTick",
    "compare.ticktick.body": "TickTick と First Light は多くの機能を共有します—両者とも集中タイマーと習慣追踡を備えています。しかし First Light は MCP 経由のネイティブ AI 連携でさらに進化しています。",
    "compare.ticktick.whenFL.1": "AI アシスタントが MCP でタスクを管理できるようにしたい",
    "compare.ticktick.whenFL.2": "AI に文脈を理解しながら一日を計画してほしい",
    "compare.ticktick.whenFL.3": "Telegram、音声、メール、スクリーンショットでタスクを追加したい",
    "compare.ticktick.whenFL.4": "シンプルで集中できる計画体験を希望する",
    "compare.ticktick.whenComp.1": "時間ブロック機能備えの内蔵カレンダービューが必要",
    "compare.ticktick.whenComp.2": "全プラットフォームのネイティブアプリ（iOS、Android、Mac、Windows）が必要",
    "compare.ticktick.whenComp.3": "共有リストのチーム共同作業が必要",
    "compare.ticktick.whenComp.4": "無料プランにより多くの機能が欲しい",
    "features.heading": "機能",
    "features.subheading": "各プランで利用できる機能と現在の権限。",
    "features.yourPlan": "現在のプラン",
    "features.plan.free": "無料",
    "features.plan.plus": "Plus",
    "features.plan.pro": "Pro",
    "features.cancels": "現在の期間終了時にキャンセル",
    "features.renews": "自動更新",
    "features.freeTip": "コアのタスク機能。AI 副駕驇はいつでも追加可能。",
    "features.manageBilling": "課金管理",
    "features.openingPortal": "ポータルを開く…",
    "features.upgradePlus": "Plus にアップグレード",
    "features.upgradePro": "Pro にアップグレード",
    "features.redirecting": "リダイレクト中…",
    "features.unlockHeading": "解锁できる機能",
    "features.matrixHeading": "並べて比較",
    "features.matrixSubFree": "鍵アイコンはプランに含まれない機能を示します。",
    "features.matrixSubPlus": "Plus の全機能を利用可能。Pro は AI 副駕驇を追加。",
    "features.matrixSubPro": "下記すべての機能を利用できます。",
    "features.shareLink": "他の人に共有したいですか？",
    "features.publicPricing": "公開料金ページ",
  ...
  ko: {
    ...
    "landing.kicker": "First Light · 빛이 닿는 곳에서, 하루가 시작된다.",
    "landing.heroLine1": "아침에 한 번 읽는 브리핑 —",
    "landing.heroLine2": "끝없이 스크롤하는 할 일 목록은 이제 그만.",
    "landing.heroBody": "First Light가 흩어진 할 일·캘린더·습관을 하나의 AI 데일리 브리핑으로 통합 — 그리고 당신과 AI 어시스턴트가 함께 실행합니다. 복사붙여넣기 필요 없이. 앱 전환 필요 없이.",
    ...
    "landing.principlesKicker": "디자인 원칙",
    "landing.principlesHeading": "매일, 다섯 가지 약속.",
    "landing.principle1Title": "명료",
    "landing.principle1Body": "생각이 맑으면 방향도 맑다.",
    "landing.principle2Title": "집중",
    "landing.principle2Body": "하나씩, 제대로.",
    "landing.principle3Title": "진보",
    "landing.principle3Body": "작은 한 걸음도 전진이다.",
    "landing.principle4Title": "평온",
    "landing.principle4Body": "조급하지 않을수록 잘 된다.",
    ...
    "nav.backToHome": "First Light으로 돌아가기",
    "nav.openApp": "앱 열기",
    "pricing.kicker": "요금제포",
    "pricing.hero.heading": "당신의 실제 계획 습관에 맞게 만든 도구。",
    "pricing.hero.body": "무료 플랜은 완전한 태스크 시스템을 영구적으로 제공합니다. Plus는 양방향 캘린더와 무제한 일보를 해제합니다. Pro는 완전한 AI 코파일럿을 제공합니다.",
    "pricing.plan.free.name": "무료",
    "pricing.plan.plus.name": "Plus",
    "pricing.plan.pro.name": "Pro",
    "pricing.plan.pro.badge": "추천",
    "pricing.cta.openApp": "앱 열기",
    "pricing.cta.startFree": "무료로 시작",
    "pricing.cta.upgradePlus": "Plus로 업그레이드",
    "pricing.cta.upgradePro": "Pro로 업그레이드",
    "pricing.cta.startWithPro": "Pro로 시작",
    "pricing.cta.openingCheckout": "결제 페이지 열는 중…",
    "pricing.matrix.heading": "전체 기능 비교",
    "pricing.matrix.subheading": "각 플랜에 포함된 완전한 기능 목록입니다.",
    "pricing.faq.heading": "자주 묻는 질문",
    "pricing.faq.q1": "언제든지 취소할 수 있나요?",
    "pricing.faq.a1": "네. 설정 \u2192 청구에서 고객 포털을 사용하세요. 구독은 이미 결제한 기간이 끝날 때까지 유효합니다.",
    "pricing.faq.q2": "다운그레이드 후 데이터는 어떻게 되나요?",
    "pricing.faq.a2": "데이터는 여러분의 것입니다. 태스크, 노트, 캘린더 연동은 무료 플랜에서도 쟁동합니다. Pro 전용 AI 기능만 중지됩니다.",
    "pricing.faq.q3": "팀 플랜이 있나요?",
    "pricing.faq.a3": "아직은요. 현재 단일 사용자 경험 향상에 집중하고 있습니다.",
    "pricing.faq.q4": "First Light는 어떤 언어를 지원하나요?",
    "pricing.faq.a4": "영어, 번체 중국어, 간체 중국어, 일본어, 한국어를 지원합니다.",
    "pricing.faq.q5": "First Light은 모바일에서 사용할 수 있나요?",
    "pricing.faq.a5": "네. First Light는 프로그레시브 웹 앱(PWA)이며, 모든 기기에서 작동합니다.",
    "pricing.faq.q6": "AI 일보는 어떻게 작동하나요?",
    "pricing.faq.a6": "매일 아침, First Light는 캘린더와 태스크를 읽고 짧은 편집 브리핑을 작성합니다. 무료는 하루 1회, Plus와 Pro는 무제한.",
    "pricing.faq.q7": "데이터는 안전한가요?",
    "pricing.faq.a7": "네. First Light는 Supabase를 사용하며, 데이터는 전송 중과 저장 시 암호화됩니다. 데이터를 판매하지 않습니다.",
    "pricing.final.note": "핵심 태스크 시스템은 영구 무료. Pro는 언제든지 취소 가능.",
    "pricing.final.ctaFree": "무료로 시작 — 카드 불필요",
    "compare.kicker": "비교",
    "compare.heading": "First Light과 다른 도구의 비교",
    "compare.subheading": "정직한 기능 비교. 어떤 경우 저희를 선택할지 알려드립니다.",
    "compare.kicker.detail": "비교",
    "compare.cta.heading": "First Light를 무료로 체험하세요",
    "compare.cta.subheading": "MCP, Telegram, 스마트 일일 계획을 갖춘 AI 네이티브 태스크 관리.",
    "compare.cta.button": "무료로 시작",
    "compare.whenFL": "First Light를 선택할 때",
    "compare.whenComp": "선택할 때",
    "compare.updated": "2026년 6월 업데이트",
    "compare.table.feature": "기능",
    "compare.table.fl": "First Light",
    "compare.todoist.heading": "First Light vs Todoist",
    "compare.todoist.body": "First Light과 Todoist 모두 태스크 정리와 하루 계획에 도움이 됩니다. 하지만 Todoist는 성숙한 통합 플랫폼이며, First Light는 AI와 MCP 중심으로 설계되었습니다.",
    "compare.todoist.whenFL.1": "AI 어시스턴트(Claude, ChatGPT)가 MCP로 직접 태스크를 관리하길 원할 때",
    "compare.todoist.whenFL.2": "Telegram, 음성, 이메일, 스크린샷으로 태스크를 추가하고 싶을 때",
    "compare.todoist.whenFL.3": "아이젤하워 매트릭스, 집중 타이머, 습관 추적을 한번에 원할 때",
    "compare.todoist.whenFL.4": "AI가 에너지와 우선순위에 따라 하루를 계획해 주길 원할 때",
    "compare.todoist.whenComp.1": "팀 협업, 공유 프로젝트, 댓글 기능이 필요할 때",
    "compare.todoist.whenComp.2": "100개 이상의 서드파티 통합(Zapier, Slack 등)에 의존할 때",
    "compare.todoist.whenComp.3": "데스크톱, 모바일, 브라우저 확장이 마련된 성숙한 에코시스템이 필요할 때",
    "compare.things.heading": "First Light vs Things 3",
    "compare.things.body": "Things 3는 아름다운 디자인과 Apple 네이티브 체험으로 유명합니다. First Light는 AI 우선 접근 방식으로 MCP 통합을 제공합니다.",
    "compare.things.whenFL.1": "AI 어시스턴트가 MCP로 태스크를 관리하길 원할 때",
    "compare.things.whenFL.2": "Windows, Android, Linux 등 크로스 플랫폼 접근이 필요할 때",
    "compare.things.whenFL.3": "집중 타이머, 습관, 아이젠하워 매트릭스가 필요할 때",
    "compare.things.whenFL.4": "AI 기반 일일 계획을 원할 때",
    "compare.things.whenComp.1": "Apple 에코시스템에서 세련된 네이티브 앱을 원할 때",
    "compare.things.whenComp.2": "구독 대신 일회성 구매를 선호할 때",
    "compare.things.whenComp.3": "인터넷 없이 완전한 오프라인 지원이 필요할 때",
    "compare.things.whenComp.4": "디자인 품질이 최우선 사항일 때",
    "compare.ticktick.heading": "First Light vs TickTick",
    "compare.ticktick.body": "TickTick과 First Light은 집중 타이머와 습관 추적 등 많은 기능을 공유합니다. 하지만 First Light는 MCP를 통한 네이티브 AI 통합으로 더 나아갔습니다.",
    "compare.ticktick.whenFL.1": "AI 어시스턴트가 MCP로 태스크를 관리하길 원할 때",
    "compare.ticktick.whenFL.2": "AI가 컨텍스트를 이해하며 하루를 지능적으로 계획하길 원할 때",
    "compare.ticktick.whenFL.3": "Telegram, 음성, 이메일, 스크린샷으로 태스크를 추가하고 싶을 때",
    "compare.ticktick.whenFL.4": "미니멀하고 집중된 계획 경험을 원할 때",
    "compare.ticktick.whenComp.1": "타임 블로킹 기능이 있는 내장 캘린더 뷰가 필요할 때",
    "compare.ticktick.whenComp.2": "모든 플랫폼(iOS, Android, Mac, Windows) 네이티브 앱이 필요할 때",
    "compare.ticktick.whenComp.3": "공유 목록으로 팀 협업이 필요할 때",
    "compare.ticktick.whenComp.4": "무료 플랜에 더 많은 기능이 포함되길 원할 때",
    "features.heading": "기능",
    "features.subheading": "각 플랜에서 사용 가능한 기능과 현재 접근 권한.",
    "features.yourPlan": "현재 플랜",
    "features.plan.free": "무료",
    "features.plan.plus": "Plus",
    "features.plan.pro": "Pro",
    "features.cancels": "현재 기간 종료 시 취소",
    "features.renews": "자동 갱신",
    "features.freeTip": "완전한 태스크 시스템. AI 코파일럿은 언제든지 추가 가능.",
    "features.manageBilling": "청구 관리",
    "features.openingPortal": "포털 열는 중…",
    "features.upgradePlus": "Plus로 업그레이드",
    "features.upgradePro": "Pro로 업그레이드",
    "features.redirecting": "리다이렉트 중…",
    "features.unlockHeading": "해제되는 기능",
    "features.matrixHeading": "나란히 비교",
    "features.matrixSubFree": "잠금 아이콘은 해당 플랜에 포함되지 않는 기능을 표시합니다.",
    "features.matrixSubPlus": "Plus의 모든 기능을 사용 중. Pro는 완전한 AI 코파일럿 추가.",
    "features.matrixSubPro": "아래의 모든 기능을 사용할 수 있습니다.",
    "features.shareLink": "다른 사람과 공유하고 싶으신가요?",
    "features.publicPricing": "공개 요금제 페이지",

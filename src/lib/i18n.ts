...
const STRINGS: Record<LanguageCode, Record<StringKey, string>> = {
  ...
  "zh-TW": {
    ...
    "landing.heroLine1": "讀一次晨間簡報 —",
    "landing.heroLine2": "不再無盡滾動待辦清單。",
    "landing.heroBody": "每天早晨，First Light 為你寫一篇關於今天的短文：什麼重要、什麼可以等、你的模式在告訴你什麼。任務、日曆和習慣在下方 — 原生 MCP 讓你的 AI 助手直接管理它們。",
  ...
  "zh-CN": {
    ...
    "landing.heroLine1": "读一次晨间简报 —",
    "landing.heroLine2": "不再无尽滚动待办清单。",
    "landing.heroBody": "每天早晨，First Light 为你写一篇关于今天的短文：什么重要、什么可以等、你的模式在告诉你什么。任务、日历和习惯在下方 — 原生 MCP 让你的 AI 助手直接管理它们。",
  ...
  ja: {
    ...
    "landing.heroLine1": "一度読むだけのモーニングブリーフ —",
    "landing.heroLine2": "果てしなくスクロールするバックログではなく。",
    "landing.heroBody": "毎朝、First Lightがあなたの一日について短いエディトリアルを書きます：何が大切か、何が待てるか、あなたのパターンが何を語っているか。タスク、カレンダー、習慣はその下に — ネイティブMCPでAIアシスタントが直接管理します。",
  ...
  ko: {
    ...
    "landing.heroLine1": "한 번 읽는 모닝 브리핑 —",
    "landing.heroLine2": "끝없이 스크롤하는 백로그가 아닌.",
    "landing.heroBody": "매일 아침, First Light가 당신의 하루에 대한 짧은 에디토리얼을 씁니다: 무엇이 중요한지, 무엇이 기다릴 수 있는지, 당신의 패턴이 무엇을 말하는지. 할 일, 캘린더, 습관은 그 아래에 — 네이티브 MCP로 AI 어시스턴트가 직접 관리합니다.",

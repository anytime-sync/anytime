...
export const metadata: Metadata = {
  title: "First Light vs Todoist — an honest comparison",
  description:
    "Looking for a Todoist alternative? An honest comparison of First Light vs Todoist — calm productivity, AI Plan-my-day, voice/snapshot/paste to task, two-way Google Calendar.",
  alternates: { canonical: "/alternatives/todoist" },
  openGraph: {
    title: "First Light vs Todoist — an honest comparison",
    description:
      "Calm productivity instead of streaks. Daily brief, AI Plan-my-day, voice/snapshot/paste to task, two-way Google Calendar.",
    url: "https://firstlight.to/alternatives/todoist",
    images: ["/og.png"],
  },
  twitter: {
...
export default async function FirstLightVsTodoist() {
  ...
  const jsonLd = {
    ...
    "@type": "Article",
    headline: "First Light vs Todoist — an honest comparison",
    ...
    mainEntityOfPage: "https://firstlight.to/alternatives/todoist",
  };
        ...
        <article className="max-w-3xl mx-auto px-6 py-16 space-y-10">
          <div className="space-y-3">
            ...
            <p className="text-stone-600 text-lg leading-relaxed">
              You probably found this page because Todoist&rsquo;s streaks and karma points started feeling
              like work about work. We&rsquo;ve been there. Here&rsquo;s how the two tools actually differ —
              including the parts where Todoist is still the better pick.
            </p>
          </div>
          ...
          <section className="rounded-2xl border border-stone-200 bg-white/60 p-6 space-y-3">
            ...
            <p className="leading-relaxed">
              <strong>Pick Todoist</strong> if you want a battle-tested cross-platform task manager with deep
          ...
          <section className="space-y-4">
            <h2 className="font-display text-2xl md:text-3xl">The honest case for Todoist</h2>
            <p className="leading-relaxed text-stone-700">
              Todoist has been shipping since 2007 and it shows. The natural-language parser is
              ...
              API. If you live across 5 devices and you need bulletproof sync, Todoist has had a decade head
            ...
            <p className="leading-relaxed text-stone-700">
              ...
              &ldquo;100+ tasks across 12 projects on 4 platforms with team collaboration,&rdquo; Todoist Pro
          ...
          <section className="space-y-4">
            ...
            <p className="leading-relaxed text-stone-700">
              Concretely, that translates into surfaces Todoist doesn&rsquo;t have:
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-stone-300">
                    ...
                    <th className="text-left font-medium py-3 px-4">Todoist</th>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-relaxed text-stone-700">
              <strong>Pick Todoist if:</strong> you need cross-device sync across 4+ platforms; you have an
            ...
            <p className="leading-relaxed text-stone-700">
              ...
              turned off Todoist&rsquo;s karma feature because it made you anxious.
            </p>
          </section>

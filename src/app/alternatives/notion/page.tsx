...
export const metadata: Metadata = {
  title: "First Light vs Notion — an honest comparison",
  description:
    "Looking for a Notion alternative? An honest comparison of First Light vs Notion — calm productivity, AI Plan-my-day, voice/snapshot/paste to task, two-way Google Calendar.",
  alternates: { canonical: "/alternatives/notion" },
  openGraph: {
    title: "First Light vs Notion — an honest comparison",
    description:
      "Calm productivity instead of streaks. Daily brief, AI Plan-my-day, voice/snapshot/paste to task, two-way Google Calendar.",
    url: "https://firstlight.to/alternatives/notion",
    images: ["/og.png"],
  },
  twitter: {
...
export default async function FirstLightVsNotion() {
  ...
  const jsonLd = {
    ...
    "@type": "Article",
    headline: "First Light vs Notion — an honest comparison",
    ...
    mainEntityOfPage: "https://firstlight.to/alternatives/notion",
  };
        ...
        <article className="max-w-3xl mx-auto px-6 py-16 space-y-10">
          <div className="space-y-3">
            ...
            <h1 className="font-display text-4xl md:text-5xl leading-tight tracking-tight">
              First Light vs Notion — an honest comparison
            </h1>
            <p className="text-stone-600 text-lg leading-relaxed">
              You probably found this page because Notion&rsquo;s streaks and karma points started feeling
              like work about work. We&rsquo;ve been there. Here&rsquo;s how the two tools actually differ —
              including the parts where Notion is still the better pick.
            </p>
          </div>
          ...
          <section className="rounded-2xl border border-stone-200 bg-white/60 p-6 space-y-3">
            ...
            <p className="leading-relaxed">
              <strong>Pick Notion</strong> if you want a battle-tested cross-platform task manager with deep
          ...
          <section className="space-y-4">
            <h2 className="font-display text-2xl md:text-3xl">The honest case for Notion</h2>
            <p className="leading-relaxed text-stone-700">
              Notion has been shipping since 2007 and it shows. The natural-language parser is
              ...
              API. If you live across 5 devices and you need bulletproof sync, Notion has had a decade head
            ...
            <p className="leading-relaxed text-stone-700">
              ...
              &ldquo;100+ tasks across 12 projects on 4 platforms with team collaboration,&rdquo; Notion Pro
          ...
          <section className="space-y-4">
            ...
            <p className="leading-relaxed text-stone-700">
              Concretely, that translates into surfaces Notion doesn&rsquo;t have:
            </p>
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-stone-300">
                    ...
                    <th className="text-left font-medium py-3 px-4">Notion</th>
          ...
          <section className="space-y-4">
            ...
            <ul className="space-y-2 ml-6 list-disc text-stone-700">
              <li><strong>Notion Free:</strong> 5 personal projects, 5 collaborators per project, 1-week activity history.</li>
              <li><strong>Notion Pro:</strong> $5/mo billed annually only (so $4/mo if you commit to 12 months). 300 projects, reminders, calendar feeds.</li>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-relaxed text-stone-700">
              <strong>Pick Notion if:</strong> you need cross-device sync across 4+ platforms; you have an
            ...
            <p className="leading-relaxed text-stone-700">
              ...
              turned off Notion&rsquo;s karma feature because it made you anxious.
            </p>
          </section>

 ...
 * then a compact 3-up row for Sift, Quick Add, and Weekly Review.
 */
    ...
    <section className="px-6 py-12 max-w-5xl mx-auto w-full">
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <div className="relative rounded-xl overflow-hidden border border-border shadow-lg shadow-stone-200/30">
            <Image
          ...
          <p className="text-center text-[11px] text-muted-fg mt-2 leading-snug">
